"""
python Extract_pbsv_indel.py    --vcf_file        HeinzReads2Pimp.var.vcf \
                                --ref_genome      Pimp_v1.2.fasta     \
                		    	--query_genome    SL4.0.genome.fasta  \
							    --Output          Pimp_ref >  Pimp_ref.log
...
parser.add_argument("--query_genome", type=str, help="Query species genome file, fasta format. The species of the query PacBio reads is same as that of this genome. \
                     This script will extract the SV-related regions in ref_genome.", required=True, default="")
