...
with open(prefix + ".sam_1-6_col", "w") as sam_infor_file, open(prefix + ".anchor.tsv", "w") as raw_alignment_tsv, open(prefix + ".variants_within_alignments.bed", "w") as sv_bed_file:
